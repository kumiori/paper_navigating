...
In our context, a bifurcation condition along the system's evolution parametrized by the control parameter(s) is associated to the uniqueness of a field of vectors tangent to the trajectory in phase space.
