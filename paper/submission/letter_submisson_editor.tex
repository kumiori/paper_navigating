...
\signature{Andrés A. León Baldelli \\ Umut Oguz Salman} % your name as you want it to appear as signature
...
Evolution in a Gradient Damage Fracture Model,}' for consideration in next issue of the Journal of the Mechanics and Physics of Solids. 
...
This offers significant insight into the effectiveness of approximate quasi-Newton algorithms, especially navigating non-convex energy landscapes, handling constraints, and complex patterns typical of fracture evolution in thin brittle films. 
...
We trust this contribution opens new avenues in understanding non-convex mechanics and nonlinear optimisation, offering tools that advance the predictive modeling of fracture processes.

\vspace{4em}

\textbf{Potential reviewers of this manuscript include:}
\begin{itemize}
    \item Jean-Jacques Marigo
    \item Roberto Alessi
\end{itemize}

for their expertise in phase-field fracture models, non-convex optimisation, and computational mechanics.
