...
\albadd{Our analysis shows that while quasi-Newton algorithms accelerate convergence, this comes at the cost of introducing unphysical effects. In particular, the approximations inherent in quasi-Newton updates may lead to solutions that appear physical yet are driven by numerical disorder rather than the governing equations.
    This sensitivity indicates that when irreversibility constraints are critical, a full Hessian approach is often necessary to accurately capture the stability and bifurcation behavior.
