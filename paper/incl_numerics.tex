...
When dealing with eigenvalue problems, this decomposition allows one to project the problem into the cone, ensuring that the solution remains within the constraints imposed by irreversibility. 
...
\begin{figure}[htbp]
    ...
    % Stability of the homogeneous solution in the first model on (a) the linear space and (b) on convex cone $K^+_0$. When the irreversibility constraint is present, the homogeneous solution is stable for any value of the loading parameter $\bar\epsilon$.
