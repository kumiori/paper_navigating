...
% , \mathsf{E'_\text{2d}}
Denoting by $\mathsf{E_\text{2d}}$ and $ h$ the two-dimensional stiffness (per unit depth) and the thickness of the film membrane, and by a prime sign the stiffness and thickness of the substrate, the nondimensional quantities appearing in the expression of the energy depend on the geometric the elastic properties of the system as follows
\begin{equation}
...
\albadd{Note that the nondimensional parameter $\Lambda$ relates the effective stiffness of the film membrane undergoing planar tensile strains, $\Youngfilm h$, to the effective stiffness of the bonding layer undergoing shear, $\Youngsubs / h'$.}
...
Admissible perturbations in the fully reversible case they belong to the \albadd{tangent} space \albadd{$T_y X_t=X_0$} associated with  $X_t$ (respectively, $\widetilde{X_t}$) \albadd{which is a linear vector space}, whereas in the irreversible case \albreplace{the tangent space $T_y X_t$ of admissible perturbations is}{they are bound to} the closed \albdelete{, pointed, }convex cone $K^+_0$ (respectively, $\widetilde{K^+_0}$).
