...
\albadd{
    Here $z$ is any admissible perturbation direction in the tangent space $T_y X_t$. If this condition is satisfied for all admissible directions $z \in T_y X_t$, the state y is considered directionally stable.
...
Admissible perturbations in the fully reversible case they belong to the \albadd{tangent} space \albadd{$T_y X_t=X_0$} associated with  $X_t$ (respectively, $\widetilde{X_t}$) \albadd{which is a linear vector space}, whereas in the irreversible case \albreplace{the tangent space $T_y X_t$ of admissible perturbations is}{they are bound to} the closed, pointed, convex cone $K^+_0$ (respectively, $\widetilde{K^+_0}$).
