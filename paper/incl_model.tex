...
\end{equation}
Notice that,  
first order conditions identify the the critical load threshold that activates the damaging process. namely, the quantity $\bar\epsilon_*^c$ is the value of the load for which the undamaged elastic state becomes unstable. It is determined injecting the elastic solution $u_h$ in the energy and computing $\delta \Estiff(u_h, 0)(0, \beta)=0$.
